...
namespace QuizApi.Migrations
{
    ...
    [Migration("20251120113110_OwnerAndUserIdsToString")]
    partial class OwnerAndUserIdsToString
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("QuizApi.Domain.ApplicationUser", null)
                        .WithMany()
            ...
            modelBuilder.Entity("QuizApi.Domain.Quiz", b =>
                {
                    b.HasOne("QuizApi.Domain.ApplicationUser", "Owner")
                        .WithMany("Creations")
            ...
            modelBuilder.Entity("QuizApi.Domain.Result", b =>
                {
                    ...
                    b.HasOne("QuizApi.Domain.ApplicationUser", "User")
                        .WithMany("History")
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
